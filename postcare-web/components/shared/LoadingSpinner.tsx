  ...
  return (
    <div className="flex flex-col items-center justify-center py-12 gap-4">
      <svg width="200" height="60" viewBox="0 0 200 60" className="overflow-visible">
        ...
        <path d="M 0,30 L 30,30 L 40,30 L 55,10 L 65,50 L 75,20 L 85,40 L 95,30 L 130,30 L 140,30 L 155,15 L 165,45 L 175,25 L 185,35 L 195,30 L 200,30" fill="none" stroke="rgba(82,82,91,0.3)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        ...
        <circle r="4" fill="#6366f1" opacity="0.8">
          <animateMotion dur="2s" repeatCount="indefinite" path="M 0,30 L 30,30 L 40,30 L 55,10 L 65,50 L 75,20 L 85,40 L 95,30 L 130,30 L 140,30 L 155,15 L 165,45 L 175,25 L 185,35 L 195,30 L 200,30" />
        </circle>
        <circle r="8" fill="#6366f1" opacity="0.12">
          <animateMotion dur="2s" repeatCount="indefinite" path="M 0,30 L 30,30 L 40,30 L 55,10 L 65,50 L 75,20 L 85,40 L 95,30 L 130,30 L 140,30 L 155,15 L 165,45 L 175,25 L 185,35 L 195,30 L 200,30" />
        </circle>
      </svg>
